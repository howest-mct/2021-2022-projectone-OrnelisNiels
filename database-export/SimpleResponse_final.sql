...
INSERT INTO `actie` VALUES (1,'Temparatuur uitlezen'),(2,'Licht uitlezen'),(3,'Joystick uitlezen'),(4,'RGB leds aan'),(5,'RGB leds uit'),(6,'RGB leds kleur veranderen'),(7,'Ventilator aan'),(8,'ventilator uit'),(9,'Status veranderen knop'),(10,'Bericht sturen naar lcd'),(11,'Bericht sturen naar website'),(12,'Ventilator automatisch'),(13,'Leds automatisch');
...
CREATE TABLE `bericht` (
  ...
  `berichtinhoud` varchar(128) NOT NULL,
  `gebruiker_gebruikerid` int NOT NULL,
  `ontvanger` int DEFAULT NULL,
...
INSERT INTO `bericht` VALUES (1,'\"Ik kom zo\"',1,NULL),(2,'\"Oke\"',1,NULL),(3,'\"Nee\"',1,NULL),(4,'\"Ja\"',1,NULL);
...
INSERT INTO `gebruiker` VALUES (1,'Raspberry Pi');
...
CREATE TABLE `historiek` (
  ...
  `waarde` varchar(20) DEFAULT NULL,
...
-- Dump completed on 2022-06-20  1:18:14
